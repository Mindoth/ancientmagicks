...
public class ModClientConfig {
    ...
    public static final ForgeConfigSpec.ConfigValue<Integer> MAGICK_BAR_X_OFFSET;
    public static final ForgeConfigSpec.ConfigValue<Integer> MAGICK_BAR_Y_OFFSET;
    ...
    static {
        ...
        MAGICK_BAR_X_OFFSET = BUILDER.comment("X Offset for magick bar in hud.")
                .define("manaBarXOffset", 0);

        MAGICK_BAR_Y_OFFSET = BUILDER.comment("Y Offset for magick bar in hud.")
