...
public class AncientMagicksContainers {
    ...
    public static final RegistryObject<MenuType<AMBagContainer>> AMBAG_CONTAINER = CONTAINERS.register("wand_container", () -> IForgeMenuType.create(AMBagContainer::fromNetwork));
}
