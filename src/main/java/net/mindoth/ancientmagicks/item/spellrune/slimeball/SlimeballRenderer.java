...
public class SlimeballRenderer extends EntityRenderer<SlimeballEntity> {
    ...
    public SlimeballRenderer(EntityRendererProvider.Context p_173962_) {
        super(p_173962_);
    }

    protected int getBlockLightLevel(SlimeballEntity p_114087_, BlockPos p_114088_) {
        return 15;
    }

    public void render(SlimeballEntity p_114080_, float p_114081_, float p_114082_, PoseStack p_114083_, MultiBufferSource p_114084_, int p_114085_) {
        p_114083_.pushPose();
        p_114083_.scale(0.8F, 0.8F, 0.8F);
        p_114083_.translate(0, -0.25F, 0);
