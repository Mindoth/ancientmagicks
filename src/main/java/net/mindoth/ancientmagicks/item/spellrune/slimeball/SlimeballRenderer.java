...
public class SlimeballRenderer extends EntityRenderer<SlimeballEntity> {
    ...
    public SlimeballRenderer(EntityRendererManager p_i46553_1_) {
        super(p_i46553_1_);
    }
    ...
    public void render(SlimeballEntity pEntity, float pEntityYaw, float pPartialTicks, MatrixStack pMatrixStack, IRenderTypeBuffer pBuffer, int pPackedLight) {
        pMatrixStack.pushPose();
        pMatrixStack.scale(0.8F, 0.8F, 0.8F);
        pMatrixStack.translate(0, -0.25F, 0);
