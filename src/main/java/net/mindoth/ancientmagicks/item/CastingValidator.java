...
public class CastingValidator {
    ...
    public static boolean isValidSpell(List<SpellComponentItem> spellStack) {
    ...
    public static String getStringFromSpellStack(List<SpellComponentItem> list) {
    ...
    public static List<SpellComponentItem> getSpellStackFromString(String string) {
        List<SpellComponentItem> spellStack = Lists.newArrayList();
        for ( String component : List.of(string.split(",")) ) {
            Item item = ForgeRegistries.ITEMS.getValue(new ResourceLocation(component));
            if ( item instanceof SpellComponentItem componentItem ) spellStack.add(componentItem);
        }
        return spellStack;
    }

    public static List<SpellComponentItem> getSpellStackFromScroll(ItemStack scroll) {
        ...
        for ( String string : List.of(stringList.split(",")) ) {
            ...
            if ( item instanceof SpellComponentItem componentItem ) componentList.add(componentItem);
        }
