package net.mindoth.ancientmagicks.item.temp.summondeathknight;
...
public class SummonDeathKnightItem extends AbstractSpellSummon {
    ...
    public SummonDeathKnightItem(Properties pProperties, int spellTier, int manaCost, int cooldown, SpellType spellType) {
