package net.mindoth.ancientmagicks.item.temp.featherfall;
    ...
    protected void applyEffect(Level level, LivingEntity owner, Entity caster, Entity target) {
        ...
        for ( Entity entity : list ) {
            if ( entity instanceof LivingEntity living ) {
                ...
                if ( living != caster ) addEnchantParticles(living, getParticleColor().r, getParticleColor().g, getParticleColor().b, 0.15F, 8);
            }
        }
    }
}
