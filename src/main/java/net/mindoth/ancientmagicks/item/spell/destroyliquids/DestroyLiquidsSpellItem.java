package net.mindoth.ancientmagicks.item.spell.destroyliquids;
...
public class DestroyLiquidsSpellItem extends BlockTargetSpell {

    public DestroyLiquidsSpellItem(Properties pProperties, int manaCost, int cooldown) {
