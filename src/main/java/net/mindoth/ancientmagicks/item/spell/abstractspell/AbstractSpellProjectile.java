...
public abstract class AbstractSpellProjectile extends SpellItem {

    public AbstractSpellProjectile(Properties pProperties, int spellTier, int manaCost, int cooldown) {
