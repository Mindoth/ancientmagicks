...
public class ExperienceStreamRenderer extends EntityRenderer<ExperienceStreamEntity> {
    private static final ResourceLocation TEXTURE_LOCATION = new ResourceLocation("textures/entity/experience_orb.png");
    private static final RenderType RENDER_TYPE = RenderType.itemEntityTranslucentCull(TEXTURE_LOCATION);

    public ExperienceStreamRenderer(EntityRendererProvider.Context p_173962_) {
        super(p_173962_);
        this.shadowRadius = 0.15F;
        this.shadowStrength = 0.75F;
    }

    protected int getBlockLightLevel(ExperienceStreamEntity p_114606_, BlockPos p_114607_) {
        return Mth.clamp(super.getBlockLightLevel(p_114606_, p_114607_) + 7, 0, 15);
    }

    public void render(ExperienceStreamEntity p_114599_, float p_114600_, float p_114601_, PoseStack p_114602_, MultiBufferSource p_114603_, int p_114604_) {
        p_114602_.pushPose();
    ...
    public ResourceLocation getTextureLocation(ExperienceStreamEntity pEntity) {
