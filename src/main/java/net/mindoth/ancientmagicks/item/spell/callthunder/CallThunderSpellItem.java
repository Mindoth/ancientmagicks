...
public class CallThunderSpellItem extends SpellItem {

    public CallThunderSpellItem(Properties pProperties, int manaCost, int cooldown) {
    ...
    private boolean callThunder(Level level, Entity caster, HitResult result, HashMap<String, Float> stats) {
        boolean state = false;
        int power = 5 + Mth.floor(stats.get(SpellItem.POWER));
